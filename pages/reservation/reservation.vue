	...
	<div class="reservation" style="overflow-x:hidden;">
		...
		<div class="reservation_btn">
			...
			<div class="content">
				<div class="fill">
					<p class="item">学员名</p>
					<input class="input_btn" type="text" placeholder="点击填写">
				</div>
				...
				<picker :range="courselist" @change="_select">
					<div class="fill">
						<p class="item">选择课程</p>
						<p class='select'>{{course}}</p>
					</div>
				</picker>

				<div class="fill">
					<p class="item">手机号码</p>
					<input class="input_btn" type="number" placeholder="点击填写" maxlength=11>
				</div>
